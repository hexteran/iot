rm -r /etc/sawtooth/n1/data && mkdir /etc/sawtooth/n1/data &&
rm /etc/sawtooth/path.toml &&
cp /etc/sawtooth/path1.toml /etc/sawtooth/path.toml &&
...
sawtooth-rest-api -vv --connect tcp://localhost:4004 --bind 192.168.0.21:8008 &
sawtooth-validator -vv --peering static --bind network:tcp://eth0:8800 --endpoint tcp://192.168.0.21:8800 --peers tcp://192.168.0.20:8800 tcp://192.168.0.22:8800 --network-auth trust #--endpoint tcp://val2:8800
